...
-- CreateEnum
CREATE TYPE "ProductVisibility" AS ENUM ('PUBLISHED', 'DRAFT', 'ARCHIVED');
...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CREDIT_CARD', 'PAYPAL', 'STRIPE', 'BANK_TRANSFER', 'CASH_ON_DELIVERY');
...
-- CreateEnum
CREATE TYPE "TransactionType" AS ENUM ('SALE', 'RESTOCK', 'RETURN', 'ADJUSTMENT', 'DAMAGED');
...
CREATE TABLE "products" (
    ...
    "visibility" "ProductVisibility" NOT NULL DEFAULT 'PUBLISHED',
    "vendorId" TEXT,
    "categoryId" TEXT,
    "seoTitle" TEXT,
    "seoDescription" TEXT,
...
-- CreateIndex
CREATE INDEX "coupon_usages_usedAt_idx" ON "coupon_usages"("usedAt" DESC);

-- CreateIndex
CREATE INDEX "inventory_transactions_productId_idx" ON "inventory_transactions"("productId");

-- CreateIndex
CREATE INDEX "inventory_transactions_createdAt_idx" ON "inventory_transactions"("createdAt" DESC);
